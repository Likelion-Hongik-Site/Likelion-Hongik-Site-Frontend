...
export const Projectph = () => {
  ...
  const getButtonClass = (tab: string) => {
    return activeTab === tab ? 'text-black bg-blue' : 'text-blue bg-black border-blue2 ring-1 hover:bg-blue2 hover:text-black transition';
  };

  const baseButtonClass = "flex items-center w-[105px] h-[44px] justify-center ph:subhead2 ph:px-[18px] ph:py-[10px] ph:rounded-[66.667px] text-center cursor-pointer transition duration-200 ease-in-out hover:bg-blue30 hover:text-blue";

  return (
    <div> 
      <div className="ph:w-[403px] h-[64px] mt-[4px] flex items-center">
        <ScrollContainer className="flex gap-[12px] ml-[28px] mr-[28px] py-[10px] px-[5px] whitespace-nowrap cursor-grab"> 
