...
export const Project = () => {
  ...
  const renderImages = (images: { image: string; name: string }[]) => {
    return (
      <div className="w-full max-w-[1665px] h-[435px] mx-auto flex justify-center dt:mb-[56px] overflow-hidden relative">
        ...
        >
          <img className="w-[80px] h-[80px] ml-[50px] cursor-pointer" src={leftArrow} alt="left" />
        </button>
        <button
        ...
        >
          <img
            className="w-[80px] h-[80px] ml-[170px] cursor-pointer"
            src={rightArrow}
            alt="right"
          />
        </button>
  ...
  const getButtonClass = (tab: string) => {
    return activeTab === tab
      ? 'text-black bg-blue'
      : 'text-blue bg-black border-blue2 ring-1 hover:bg-blue30 hover:text-blue transition';
  };
