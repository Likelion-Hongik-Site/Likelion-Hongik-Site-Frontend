...
export const HomePage = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <h1 className="ph:heading1 dt:heading1 text-white mt-[100px]">멋쟁이사자처럼</h1>
      <div className="dt:body1 text-gray7 flex flex-col items-center mt-[14px]">
        <p>‘멋쟁이사자처럼’은 국내 최대 규모의 전국 대학 연합 IT 동아리입니다.</p>
        <p>코딩을 모르더라도 함께 배우며 아이디어를 실현하려는 열정만 있다면 지원 가능합니다.</p>
      </div>
      <div className="flex flex-col gap-3 dt:subhead3 mt-9">
      ...
      >
        <span className="dt:subhead1 text-gray9 mr-[22px]">홍익대학교 멋사 13기 지원하기</span>
