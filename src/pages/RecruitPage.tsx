    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center bg-black">
      <div className="w-full max-w-[1230px] relative">
        <div className="flex flex-col  items-start text-left relative">
          <span className="text-white dt:heading1-eng">RECRUITING</span>
          <span className="text-gray4 absolute left-0 top-[215px] opacity-50 dt:body1">
        ...
        <div className="flex gap-[18px] mt-10">
          <button
            className={`flex items-center justify-center dt:subhead2 px-7 py-4 rounded-[100px] text-center cursor-pointer
          ...
          <a
            ...
            className="flex items-center justify-center dt:subhead2 px-7 py-4 rounded-[100px] bg-black text-blue2 text-center cursor-pointer border-blue2 ring-1 hover:bg-blue2 hover:text-black transition"
          >
            지원 폼 작성하기
          </a>
        </div>
